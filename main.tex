...
\begin{figure}[H]
\begin{center}
\frame{\includegraphics[width=0.8\paperwidth,keepaspectratio]{domen.jpg}}
\end{center}
...
\begin{figure}[H]
\begin{center}
\frame{\includegraphics[width=0.4\paperwidth,keepaspectratio]{CORRONa.png}}
\end{center}
...
\begin{figure}[H]
\begin{center}
\frame{\includegraphics[width=0.4\paperwidth,keepaspectratio]{example-image.jpg}}
\end{center}
